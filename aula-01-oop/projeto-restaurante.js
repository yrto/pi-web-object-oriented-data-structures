const rangeCategorias = ['Lanches', 'Brasileira', 'Japonesa'];
...
class Pizza extends Prato {
    ...
    toItemString() {
        return `Pizza ${this.nome} tamanho ${this.tamanho} com massa ${this.tipoMassa}`
    }
}
...
const marguerita = new Pizza('Marguerita', 24.00, 'Pizza', 8, ['molho de tomate', 'muçarela', 'manjericão'], 'grande', 'fina');
console.log(marguerita.toItemString())
